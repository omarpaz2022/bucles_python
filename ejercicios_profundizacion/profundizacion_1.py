...
sumatoria = 0
cantidad_numeros = 0  # contador de la cantidad de numeros
promedio = 0 


for numero in range ( inicio, fin + 1): 
    sumatoria += numero     # suma los numeros
    cantidad_numeros += 1   # contador de la cantidad de numeros 


promedio = sumatoria / cantidad_numeros 

print("La cantidad de numeros ingresados es:" ,cantidad_numeros) 
